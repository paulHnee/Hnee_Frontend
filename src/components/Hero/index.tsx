...
import team from '@/assets/images/itsz_Team.png';
import zammad from '@/assets/images/logo_zammad.png';
import info from '@/assets/images/itsz_FAQ.png';
      ...
      <section className="my-16 text-center">
        ...
        <ul className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-8 items-center">
          ...
          <li className="flex flex-col items-center space-y-4 p-4 center-info">
            <Link
              href="https://zammad.hnee.de/help"
              target="_blank"
              rel="noopener noreferrer"
            >
